...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-9-22-dsktp-spanish.jpg",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
...
usi_js.display_vars.p1_html = [
	'<div class="usi_sr_only">shutterstock flex. Obt\u00E9n im\u00E1genes, v\u00EDdeos y m\u00FAsica. Todo en 1 plan.</div>',
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="Comenzar ahora"></button>',
].join('');
